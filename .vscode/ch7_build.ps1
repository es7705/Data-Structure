...
$vcxprojPath = "d:\My data\Study\Coding\Data-Structure\ch7 Tree\ch7 Tree.vcxproj"
$msbuild     = 'C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\amd64\MSBuild.exe'
$exePath     = "d:\My data\Study\Coding\Data-Structure\ch7 Tree\x64\Debug\ch7 Tree.exe"

if ($section) { Write-Host "==> Section: $section" -ForegroundColor Cyan }
else          { Write-Host "==> File: $exactFile"  -ForegroundColor Cyan }
...
if ($section) {
    ...
    $pattern = '(<ClCompile Include="' + [regex]::Escape($exactFile) + '">)([\s\S]*?)(</ClCompile>)'
}
...
$objDir = "d:\My data\Study\Coding\Data-Structure\ch7 Tree\ch7 Tree.75899708\x64\Debug"
if (Test-Path $objDir) {
